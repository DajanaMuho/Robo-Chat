...
def QUESTION_SEARCH(user_input, DATA_FULL):
    # takes in a user response and a dataset, gets the best responses and asks the user if that's what they were looking for
    BEST = Universal_Sentence_Encoder.get_closest_answers(user_input, DATA_FULL)
